...
if (isset($_GET['id'])) :
    ...
    $sql = new LocalEntregaControle();
    $obj = json_decode($sql->buscarLocalEntregaId($id));
    if (!empty($obj)) :
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <input type = "hidden" id = "area" value = "local_entrega" />
                        <span class = "section">Local de Entrega</span>
                        <form class="form-horizontal form-label-left" id = "formulario" action = "view/localEntrega/salvar.php" method = "post" enctype = "multipart/form-data">
