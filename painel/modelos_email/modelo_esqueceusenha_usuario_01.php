...
$email = $_SESSION['esqueceu_senha_email'];

include '../../painel/config/crud.php';
include '../controle/usuarioControle.php';

$usuario = new UsuarioControle();
$sqlusuario = json_decode($usuario->buscarUsuarioEmail($email));
if (!empty($sqlusuario)) :
    foreach ($sqlusuario as $registro):
        $meu_nome = utf8_decode($registro->nome);
        $meu_email = utf8_decode($registro->email);
        $minha_senha = utf8_decode($registro->senha);
    endforeach;
endif;

$titulo = 'Esqueceu sua senha ?';
$titulo_pagina = 'Esqueceu sua senha ? | Usuário';
$texto_01 = utf8_decode('Olá ' . $meu_nome . ', você está fazendo um pedido que esqueceu sua senha!!');
$texto_02 = utf8_decode('Caso não seja você, entre em contato com o responsável da empresa!');
                                                                                ...
                                                                                <tr style="border-collapse:collapse"> 
                                                                                    <td valign="top" align="center" style="padding:0;Margin:0;width:600px"> 
                                                                                        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#ffffff;border-radius:4px" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"> 
                                                                                            <tr style="border-collapse:collapse"> 
                                                                                                <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px"><h1 style="Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111"><?php echo $titulo ?></h1></td> 
                                                                                            </tr> 
                                                                                            <tr style="border-collapse:collapse"> 
                                                                            ...
                                                                            <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                                                                                <tr style="border-collapse:collapse"> 
                                                                                    <td valign="top" align="center" style="padding:0;Margin:0;width:540px"> 
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                                                                                            <tr style="border-collapse:collapse"> 
                                                                                                <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px"><span class="es-button-border" style="border-style:solid;border-color:#7c72dc;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><img src="http://www.mssistemasbr.com.br/teste/esqueceu_senha_01.jpg" width="300" height="360"></span></td> 
                                                                                            </tr> 
                                                                                        </table></td> 
                                                                                </tr> 
                                                                            </table></td> 
