...
(function(h) {
    ...
    function Da(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "Sem dados disponíveis na tabela" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function Ta(a, b, c) {
        ...
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 :
            "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "próximo" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : L(a, 0, "Unknown paging action: " + b, 5);
    ...
    h.extend(Mb, {
        simple: function() {
            return ["previous", "próximo"]
        },
        full: function() {
            return ["first", "previous", "próximo", "last"]
        },
        ...
        simple_numbers: function(a, b) {
            return ["previous", ya(a, b), "próximo"]
        },
        full_numbers: function(a, b) {
            return ["first", "previous", ya(a, b), "próximo", "last"]
        },
        _numbers: ya,
        numbers_length: 7
    });
