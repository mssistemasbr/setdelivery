...
if (isset($_GET['id'])) :
    ...
    $obj = json_decode($sql->buscarTipoPizzaId($id));
    if (!empty($obj)) :
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <input type = "hidden" id = "area" value = "tipo_pizza" />
                        <span class = "section">Tipo de Pizza</span>
                        <form class="form-horizontal form-label-left" id = "formulario" action = "view/tipoPizza/salvar.php" method = "post" enctype = "multipart/form-data">
