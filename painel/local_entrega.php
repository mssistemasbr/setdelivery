...
$obj = json_decode($sql->buscarTodosLocalEntrega());
?>
<!-- page content -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <input type="hidden" value="cad_local_entrega" id="area" />   
                    <input type="hidden" value="local_entrega" id="caminho" />
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($obj as $registro):
                                ?>
                                <tr style="cursor: pointer;" class="<?= base64_encode($registro->id_local_entrega) ?>">
